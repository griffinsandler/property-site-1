...
tenants  =Tenant.create([{:name =>'Sam Springer', :phone_number =>'9876543210', :email =>'sam@springer.edu', :property_id => 8, :password => 'password', :rent => 'Yes'}])
...
tenants  =Tenant.create([{:name =>'Chuck Rogers', :phone_number =>'6574839201', :email =>'chuck@rogers.com', :property_id => 8, :password => 'password', :rent => 'No'}])
